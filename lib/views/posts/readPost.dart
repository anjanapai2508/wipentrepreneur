...
class _ReadPostState extends State<ReadPost> {
  ...
  Widget build(BuildContext context) {
    //var noOfComments = widget.showPost.comments.length;
    List<String> listOfComments = [];
    print("no of comments on this post : " +
                                        ...
                                        MarkdownWidget(
                                          ...
                                          styleConfig: StyleConfig(
                                            titleConfig: TitleConfig(
                                              showDivider: false,
                                              commonStyle: TextStyle(color: Colors.red, fontSize: 50
                                              ),
                                            ),
...
//                                )),
                                      // FormattedText(widget.showPost.body, 22,
