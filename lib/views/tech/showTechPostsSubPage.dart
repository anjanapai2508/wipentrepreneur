...
class ShowTechPostsSubPage extends StatelessWidget {
  final String techName;
  const ShowTechPostsSubPage({Key key, this.techName}) : super(key: key);
  static const String route = '/tech/flutter';
  @override
      ...
      child: Column(
        children: <Widget>[
          ...
          FutureBuilder<List<Posts>>(
            future: DbOperations().getAllTechPosts(techName),
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      DateTime publishedDate =
                          DateTime.parse(post.publishedDate);
                                    ...
                                    Expanded(
                                        ...
                                        child: Column(
                                          children: <Widget>[
                                            ...
                                            FormattedText(post.title, 20,
                                                Colors.black, TextAlign.center),
                                            FormattedText(post.subtitle, 15,
                                                Colors.black, TextAlign.center),
                                            SizedBox(
                                              height: 20,
                                            ),
